package de.melanx.spookyjam2020.api.recipe.builders;
...
public class HeatSourcesBuilder {
    ...
    public void build(Consumer<IFinishedRecipe> consumer, ResourceLocation id) {
        this.validate(id);
        consumer.accept(new FinishedRecipe(new ResourceLocation(id.getNamespace(), SpookyJam2020.MODID + "_heat_sources/" + id.getPath()), this.heatValue, this.heatState, this.group == null ? "" : this.group));
    }
